/**
 * q1w_telgoo5_return_middleware.js
 * @NApiVersion 2.1
 * @module q1w_telgoo5_return_middleware
 */
...
const TITLE = 'q1w_telgoo5_return_middleware';
...
const validateAndParse = (context, next) => {
  ...
  try {
    ...
    if (jsonObj['return-authorization-submission']?.detail) {
      Telgoo5XmlHelper.normalizeLineItems(jsonObj['return-authorization-submission'].detail);
    }

    const validatedFields = Telgoo5Validator.validateReturn(jsonObj);
